package com.brandonzx3.voidmod.world.gen.chunk;
...
public class ChunkGeneratorVoid implements IChunkGenerator
{
    ...
    */
    ...
    public ChunkGeneratorVoid(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(ModBiomes.VOID_DIMENSION);
        }
